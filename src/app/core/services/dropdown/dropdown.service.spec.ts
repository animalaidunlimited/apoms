...
describe('DropdownService', () => {
  ...
  it('getExclusions() should return data', () => {
    ...
    let dummyExclusions = [
      {"animalType":"Bird","exclusionList":["Horn/hoof problem","Normal behaviour - biting","Penis coming out","Pregnancy problem","Shifted puppies"]},
      {"animalType":"Buffalo","exclusionList":["Can't fly","Shifted puppies"]},
  ...
  it('getAnimalTypes() should return data', () => {
    ...
    let animalTypes = [{"AnimalTypeId":1, "AnimalType":"Cat"}]

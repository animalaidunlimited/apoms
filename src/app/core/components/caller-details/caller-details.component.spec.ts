...
describe('CallerDetailsComponent', () => {
  ...
  it('Invalid form - caller name only', () => {
    component.recordForm.get('callerDetails.callerName').setValue("Alfred Bumblehorn");

    expect(component.recordForm.get("callerDetails").valid).toEqual(false);
  });

  it('Invalid form - caller number only', () => {
    component.recordForm.get('callerDetails.callerNumber').setValue("8956874569");

    expect(component.recordForm.get("callerDetails").valid).toEqual(false);
  });

  it('Invalid form - alternative only', () => {
    component.recordForm.get('callerDetails.callerAlternativeNumber').setValue("8956874569");
  ...
  it('Valid form - caller name, number, and alternative', () => {
    ...
    component.recordForm.get('callerDetails.callerName').setValue("Alfred Bumblehorn");
    component.recordForm.get('callerDetails.callerNumber').setValue("8956874569");
    component.recordForm.get('callerDetails.callerAlternativeNumber').setValue("8905797444");
  ...
  it('Invalid form - Wrong placement of +', () => {
    ...
    component.recordForm.get('callerDetails.callerName').setValue("Alfred Bumblehorn");
    component.recordForm.get('callerDetails.callerNumber').setValue("8956+874569");
  ...
  it('Invalid form - all spaces', () => {
    ...
    component.recordForm.get('callerDetails.callerName').setValue("Alfred Bumblehorn");
    component.recordForm.get('callerDetails.callerNumber').setValue("          ");
  ...
  it('Invalid form - Letters', () => {
    ...
    component.recordForm.get('callerDetails.callerName').setValue("Alfred Bumblehorn");
    component.recordForm.get('callerDetails.callerNumber').setValue("Letters are here");
  ...
  it('Invalid form - symbols', () => {
    ...
    component.recordForm.get('callerDetails.callerName').setValue("Alfred Bumblehorn");
    component.recordForm.get('callerDetails.callerNumber').setValue("6668889$%^**");
  ...
  it('Invalid form - alternative symbols', () => {
    ...
    component.recordForm.get('callerDetails.callerName').setValue("Alfred Bumblehorn");
    component.recordForm.get('callerDetails.callerNumber').setValue("6668889");
    component.recordForm.get('callerDetails.callerAlternativeNumber').setValue("6668889$%^**");
  ...
  it('Invalid form - alternative letter', () => {
    ...
    component.recordForm.get('callerDetails.callerName').setValue("Alfred Bumblehorn");
    component.recordForm.get('callerDetails.callerNumber').setValue("6668889");
    component.recordForm.get('callerDetails.callerAlternativeNumber').setValue("Letters here");
